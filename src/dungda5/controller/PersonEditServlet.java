...
public class PersonEditServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Person person = null;
			try {
				person = PersonUtils.getByID(personID);
		...
		RequestDispatcher dispatcher = request.getServletContext()
				.getRequestDispatcher("/WEB-INF/views/EditPerson.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Person person = new Person(personID, firstName, lastName, gender, phoneNumber, email, address, hobbies,
				description);
		try {
			PersonUtils.updatePerson(person);
		} catch (ClassNotFoundException | SQLException e) {
			e.printStackTrace();
		}
